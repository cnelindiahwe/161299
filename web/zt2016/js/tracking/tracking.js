$(function(){
   ...
   $("#ongoing_jobs_table td:nth-of-type(4)").find("a").each(function () {
       $(this).attr("data-bs-original-title", localuserdate($(this).attr("data-bs-original-title")));
   });	
   ...
   if (myTentatives>0) {			
       $('#top-panel .panel-heading .tracking_page_button_order_desk h4').append("<a  id='showtentative' class='btn btn-info btn-sm pull-right showtentative'>Show " + myTentatives + " Tentative(s)</a>");
       $('#top-panel .panel-heading .tracking_page_button_order_mob h4 .prepand').append("<a  id='showtentative' class='btn btn-info btn-sm pull-right showtentative'>Show " + myTentatives + " Tentative(s)</a>");
       $('#top-panel .panel-heading .tracking_page_button_order_desk h4').append("<a id='hidetentative' class='btn btn-info btn-sm pull-right hidetentative'>Hide " + myTentatives + " Tentative(s)</a>");
       $('#top-panel .panel-heading .tracking_page_button_order_mob h4 .prepand').prepend("<a id='hidetentative' class='btn btn-info btn-sm pull-right hidetentative'>Hide " + myTentatives + " Tentative(s)</a>");
       $('#hidetentative').hide();		
       $('p #hidetentative').hide();		
   }
   ...
   if (checked) {
     ...
     return true;
       ...
       //	toptable.fnFilter( '^(?:(?!TENTATIVE).)*$\r?\n?',1, true, false);
        ...
        //    $("p #hidetentative").click(function() {
        //     //toptable.fnFilter( '^(?:(?!TENTATIVE).)*$\r?\n?',1, true, false);
        //     $('p #hidetentative').hide();
        //     $("p #showtentative").show();	
        //     alert('fd');
        ...
        //    $("p #showtentative").click(function() {
        //     alert('ef');

        //     //toptable.fnFilter('',1, true, false);
        //     $('p #hidetentative').show();
        //     $("p #showtentative").hide();	
        //     toptable.draw();
        //     return false;

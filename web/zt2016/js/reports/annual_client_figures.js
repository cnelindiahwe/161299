$(function(){
	...
	$('.panel-heading').append('<a href="" id="ButtonOriginators" class="ChartButton btn btn-default btn-xs">Originators</a>');
	$('.panel-heading').append('<a href="" id="ButtonHoursJob" class="ChartButton btn btn-default btn-xs">Hours per Job</a>');
	$('.panel-heading').append('<a href="" id="ButtonHoursOriginator" class="ChartButton btn btn-default btn-xs">Hours per Originator</a>');
	$('.panel-heading').append('<a href="" id="ButtonJobsOrginators" class="ChartButton btn btn-default btn-xs">Jobs per Originator</a>');
	...
	$('#ButtonOriginators').click(function() {
		draw_momentum_chart(3);
		$(".panel-title").append('<span>Number of Originators</span>');		
	});
	
	$('#ButtonHoursJob').click(function() {
		draw_momentum_chart(4);
		$(".panel-title").append('<span>Average Hours per Job</span>');		
	});
	
	$('#ButtonHoursOriginator').click(function() {
		draw_momentum_chart(5);
		$(".panel-title").append('<span>Average Hours per Originator</span>');		
	});
	
	$('#ButtonJobsOrginators').click(function() {
		draw_momentum_chart(6);
		$(".panel-title").append('<span>Average Jobs per Originator</span>');		
	});	

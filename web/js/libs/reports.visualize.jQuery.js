...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			colFilter: ' ',
			//below extended
			colors: ['#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744','#24913C','#aaaaaa','#38E05D','#666666','#D25FD2','#A68100','#FFE073','#9CB72E','#dddddd','#333333'],
		...
		function scrapeTable(){
			...
			var tableData = {
				...
				topValue: function(){
						...
						if (topValue>100) {
							topValue =Math.round(topValue / 50) * 50;
						} else if (topValue>50)  {
							topValue =Math.round(topValue / 10) * 10; 
						} else {
							topValue =Math.round(topValue / 5) * 5;
						}
						return topValue;
				},

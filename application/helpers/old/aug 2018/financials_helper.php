 ...
 */
	...
	function _MonthPricestable($monthtotal,$StartDate){
			...
			//$output="<div class=\"content\"><h3 class=\"title\">".number_format($hourstotal, 2)." hours xxx completed in ".Date('F Y', strtotime($StartDate))." = ";
 ...
 */
 	function  _buildSplitTables($AllTotals,$StartDate,$EndDate,$Status,$ClientList,$monthtotals,$Partners)
	{
				...
				if ($Partner!=""){
					...
					echo $Partner;
					if ($Partner=="Vaishali" || $Partner=="Tarun" || $Partner=="Manali" || $Partner=="Kanchan" || $Partner=="Agnel" || $Partner=="Ganesh"){

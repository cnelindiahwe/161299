...
// ################## clients control ##################	
	...
	*/
	...
	function  zt2016_getClientForm( $TimezonesList, $CountriesList, $GroupList,$CurrentClient='')
	{
		...
		'Production'=>'Production', 'ClientDir'=>'Client Directory','GroupDir'=>'Group Directory','ClientGuidelines'=>'Client Guidelines', 'OfficeVersion'=>'Office Version','CustomApps'=>'Custom Apps','Other'=>'Other','OtherInfo'=>'Other Info');
		...
		foreach ($subsections as $key=>$value){
			...
			if (in_array($key,$Headers)) {
				...
				if (in_array($key,$ColHeaders)) {
					...
					$editClientForm .="<div class=\"col-sm-4\">\n";
				}
				...
				if ($key=='Basic' || $key=='Pricing' ) {
					...
					$editClientForm .="		<div class=\"col-sm-12\"><h5 class=\"text-uppercase text-info ".$currentheader."\">".$key."</h5></div>\n";
				}
			} else{ 
				### Textareas
				$textboxes = array("Address","VATOther","CustomApps","ClientGuidelines","BillingGuidelines","OtherInfo",);
				...
				### dropdowns
					...
					$editClientForm .="	<div class=\"col-sm-6\">\n";
				 	$editClientForm .= "			".form_label($value.":",$key);
					$editClientForm .="			";
					if (isset($CurrentClient->ID)) {
				...
				$editClientForm .="		";	
				if ($size=='3') { 
					$editClientForm .="<div class=\"col col-sm-6\">\n";
				} else {
					$editClientForm .="<div class=\"col col-sm-12\">\n";
				}
				$editClientForm .= "				".form_label($value.":",$key);

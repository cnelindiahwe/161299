...
class Zt2016_monthly_clients_breakdown extends MY_Controller {
	...
	function index()
	{
		...
		$templateData['title'] = $report_month.' Monthly Clients Breakdown - ZOWTrak';
	...
	function _create_page($report_month,$ZOWuser)
	{
		...
		$page_content.='<div class="row panel-heading">'."\n";
		$page_content.='<div class="col-sm-12">'."\n";
			...
			### Month Tile and selector
				...
				$month_selector_info['FormURL']=site_url()."reports/zt2016_monthly_clients_breakdown";
				...
				$page_content.='<h4 >'."\n";
				$page_content.=	'<div class="pull-left" style="margin-right:1rem; padding-top:.7rem;">Monthly Clients Breakdown for</div>'."\n";
				$page_content.=month_selector($report_month,$start_month,$month_selector_info)."\n";

		
				########## left buttons
				##### monthyl client breakdown button
				$page_content.='<a href="'.site_url().'reports/zt2016_monthly_originators_breakdown/'.$report_month.'" class="btn btn-info btn-sm">Originators Data</a>';		
				### annual clients breakdown button
				$page_content.='<a href="'.site_url().'reports/zt2016_annual_clients_breakdown/'.date('Y',strtotime($report_month)).'" class="btn btn-primary btn-sm">Annual Data</a>';		
...
/**/
	...
	function _create_month_table($options)
	{
				...
				if ($numjobs >0) {
					...
					$split.='<table id="breakdown-table" class="table table-striped table-condensed display compact">'."\n<thead><tr><th class=\"\" data-sortable=\"false\">Group</th><th class=\"\" data-sortable=\"false\">Client</th><th class=\"\" data-sortable=\"true\">Booked Hours</th><th class=\"\" data-sortable=\"true\">Jobs</th><th class=\"\" data-sortable=\"true\">New</th><th class=\"\" data-sortable=\"true\">Edits</th><th class=\"\" data-sortable=\"true\">Hours</th></tr></thead>";

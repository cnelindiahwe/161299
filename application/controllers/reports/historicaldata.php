...
class Historicaldata extends MY_Controller {
	...
	function index()
	{
		...
		$templateVars['pageName'] = "historicaldata";
		$templateVars['pageType'] = "historicaldata";
 ...
 */
 	function _totalstables($options=array()){
		...
		$reportresults .="<thead><th></th><th>Billed Hours</th><th>Jobs</th><th>Clients</th><th>Originators</th><th>New Clients</th><th>New Originators</th></thead><tbody>";

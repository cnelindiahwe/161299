		...
		$page_content.='<div class="panel-heading">'."\n";
			...
			$page_content.= '</small></h3>'."\n";		
				...
				$page_content.= '<div>'."\n";			
					...
					########## quotation button
					if ($ZOWuser=="miguel" || $ZOWuser=="sunil.singal"  || $ZOWuser=="jirka.blom" ) {
						$page_content.= '<a href="'.site_url().'clients/zt2016_client_quotation/'.$SafeclientName.'" class="btn btn-primary btn-sm">Quotation</a>';		
					}
		
					########## invoices button
					if ($ZOWuser=="miguel" || $ZOWuser=="sunil.singal"  || $ZOWuser=="jirka.blom" ) {
						$page_content.='<a href="'.site_url().'invoicing/zt2016_client_invoices/'.$SafeclientName.'" class="btn btn-primary_hwe btn-sm">Invoices</a>';
					}
					...
					$page_content.='		<input type="submit" id="pastjobssubmit" name="pastjobssubmit" value="Past Jobs" class="btn btn-sm btn-default_hwe" >'."\n";
					$page_content.='	</div>'."\n";
					$page_content.="</form>"."\n";
					...
					########## edit button
					if ($ZOWuser=="miguel" || $ZOWuser=="sunil.singal" || $ZOWuser=="jirka.blom") {
						$page_content.='<a href="'.site_url().'clients/zt2016_client_edit/'.$SafeclientName.'" class="btn btn-success btn-sm pull-right">Edit</a>';
					}

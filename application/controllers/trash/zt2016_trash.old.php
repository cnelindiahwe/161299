	...
	// ################## display trashed groups info ##################	
		...
		function  _trashed_groups_table($GroupsData)
		{
			...
			foreach($GroupsData as $GroupsDetails)
			{
				...
				$GroupsTable .='<td> <a href="'.site_url().'groups/zt2016_group_restore/'.$GroupsDetails->ID.'" class="btn btn-success btn-xs" id="RestoreGroup'.$GroupsDetails->GroupName.'">Restore</a></td>'."\n";
				$GroupsTable.='<td> <a href="'.site_url().'groups/zt2016_group_delete/'.$GroupsDetails->ID.'" class="btn btn-danger btn-xs btn-delete" id="DeleteGroup'.$GroupsDetails->GroupName.'">Delete</a></td>'."\n";
	...
	// ################## display trashed clients info ##################	
		...
		function  _trashed_clients_table($ClientsData)
		{
			...
			foreach($ClientsData as $ClientDetails)
			{
				...
				$ClientsTable .='<td> <a href="'.site_url().'clients/zt2016_client_restore/'.$ClientDetails->ID.'" class="btn btn-success btn-xs" id="RestoreClient'.$ClientDetails->CompanyName.'">Restore</a></td>'."\n";
				$ClientsTable .='<td> <a href="'.site_url().'clients/zt2016_client_delete/'.$ClientDetails->ID.'" class="btn btn-danger btn-xs btn-delete" id="DeleteClient'.$ClientDetails->CompanyName.'">Delete</a></td>'."\n";
		...
		function  _trashed_contacts_table($ContactsData)
		{
			...
			foreach($ContactsData as $ContactDetails)
			{
				...
				$ContactsTable .='<td> <a href="'.site_url().'contacts/zt2016_contact_restore/'.$ContactDetails->ID.'" class="btn btn-success btn-xs" id="RestoreContact'.$Contact_Full_Name.'">Restore</a></td>'."\n";
				$ContactsTable .='<td> <a href="'.site_url().'contacts/zt2016_contact_delete/'.$ContactDetails->ID.'" class="btn btn-danger btn-xs btn-delete" id="DeleteContact'.$Contact_Full_Name.'">Delete</a></td>'."\n";

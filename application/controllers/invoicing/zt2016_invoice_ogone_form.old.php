...
<html>
	...
	<script type="text/javascript" src="https://www.zebraonwheels.com/web/js/libs/jquery-1.7.1.min.js"></script>
	<script type="text/javascript" src="web/js/thankyouinvoice.js"></script>
	<link type="text/css" rel="stylesheet" href="https://www.zebraonwheels.com/web/css/site.css" />
	</head>
	<body class="paymentsinvoice">
		<div id="site-wrapper">
			<header>
			<a href="../home"><img id="logo" src="https://www.zebraonwheels.com/web/media/ui/logo.png" height="64" width="294" alt="Zebra on Wheels"></a>
			...
			<ul id="menu">
				...
				<li><a href="https://www.zebraonwheels.com/home"  >Home</a></li>
				<li><a href="https://www.zebraonwheels.com/services"  >Services</a></li>
				<li><a href="https://www.zebraonwheels.com/approach"  >Approach</a></li>
				<li><a href="https://www.zebraonwheels.com/credentials" >Credentials</a></li>
			</ul>
			</header>

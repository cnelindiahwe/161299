 ...
 */
 	...
 	function _calculateMonthPrices($options=array()){
			...
			unset ($options);
			$bookeddata = $this->trakreports->_getAllClientTotalsByDate($options=array('StartDate'=>$StartDate,'EndDate'=>$EndDate,'Booked'=>1));
			if (isset($bookeddata)){
 ...
 */
	...
	$options = array_reverse($options);
	 ...
	 $entryForm = form_open(site_url().'invoicing/financials', $attributes)."\n";
	$entryForm .="<fieldset>";

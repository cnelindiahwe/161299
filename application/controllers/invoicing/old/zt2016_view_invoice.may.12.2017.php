...
class Zt2016_view_invoice extends MY_Controller {
	...
	function  zt2016_display_existing_invoice($invoiceTotals,$clientInfo)
	{
		...
		$pageOutput.='<li role="presentation"><a href="#invoice-notes" aria-controls="invoice-notes" role="tab" data-toggle="tab">Notes</a></li>'."\n";
		$pageOutput.='</ul>'."\n";
		...
		#################   Tab 2 - Invoice notes 
  		...
  		$pageOutput.='	<div role="tabpanel" class="tab-pane active" id="invoice-notes">'."\n";
			...
			#################  Invoice notes
				$pageOutput.='		<div class="col-md-4">'."\n";
	 			...
	 			$pageOutput.='			<h5>Invoice Notes</h5>'."\n";		
			...
			$pageOutput.='		<div class="col-md-4">'."\n";
	 			...
	 			$pageOutput.='			<h5>Contact Notes</h5>'."\n";		
			...
			$pageOutput.='		<div class="col-md-4">'."\n";
				...
				$ndata = array('class' => 'Notes-Submit-Button btn btn-sm','value' => 'Update Client Notes');

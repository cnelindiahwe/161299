...
class Zt2016_existing_invoices extends MY_Controller {
	...
	function _get_existing_invoices_table() {
		...
		$page_content.="</thead>"."\n";
		$page_content.="<tfoot>"."\n";
		$page_content.="<tr><th data-sortable=\"true\">Invoice Number</th><th data-sortable=\"true\">Client</th><th data-sortable=\"true\">Billed</th><th data-sortable=\"true\">Due</th><th data-sortable=\"true\">Paid</th><th data-sortable=\"true\" class=\"text-right\">Amount</th><th data-sortable=\"true\">Currency</th><th data-sortable=\"true\">Status</th></tr>"."\n";
		$page_content.="</tfoot>"."\n";		
		$page_content.="<tbody>"."\n";

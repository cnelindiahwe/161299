...
class Invoiceogoneform extends MY_Controller {
	...
	function index()
	{
		...
		$this->load->helper(array('clients','general','form','userpermissions', 'url','invoice','security'));
	...
	function 	_getinvoiceinfo($invoicenumber,$invoicetotal){
		...
		$content.="<textarea rows=\"10\" cols=\"150\" name=\"INVOICEHTML\" style=\"border:1px solid #a9a9a9;margin:.25em 0 0\">";
		...
		$content.="<br/>";
		$content.='<input type="submit" name="postogonetoZOWsite" value="Post to ZOW website" style="padding:.25em;margin:1em 0 0;">';
		$content.="<form>";	
		return $content;

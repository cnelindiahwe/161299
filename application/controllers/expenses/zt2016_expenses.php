        ...
        <div class="panel-heading">
            <div class="row align-items-center">
                ...
                <div class="col-auto float-end ms-auto">
                    ...
                    <a href="'.site_url().'expenses/zt2016_csv_create_expenses/" class="btn add-btn btn-info"><i class="fa fa-file"></i>Export</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
            ...
            <div class="row filter-row">
                <div class="col-sm-6 col-md-3 col-lg-3 col-xl-2 col-12">  
                    <div class="form-group form-focus">
                        <input type="search" class="form-control floating" name="item" id="customSearch">
            ...
            foreach($expensesData as $expenses){
                ...
                $page_content.='
                    ...
                    data-paymentdate="'.$expenses->paymentDate.'">
                        ...
                        <td>'.$currencySymbol.$expenses->amount.'</td>
                        ...
                        <td class="">
                            <div class="dropdown action-label">
                                ...
                                <div class="dropdown-menu dropdown-menu-right expenses">
                        ...
                        if($expenses->paymentAmount > 0){
                            $page_content.='
                            <td>'.$currencySymbol.$expenses->paymentAmount.'</td>';
                        }else{
                            $page_content.='
                            <td>-</td>';
                        }
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="vertical-align: unset;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="'.site_url().'expenses/zt2016_expensesdata" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Amount</label>
                                        <input placeholder="amount" class="form-control" type="number" name="amount" required="true">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input placeholder="payment" class="form-control" type="number" name="paymentAmount" required="true" value="0">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="attach" type="file" name="attach">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Purchase Date</label>
                                <div class="cal-icon"><input class="form-control datetimepicker" type="text" name="purchaseDate"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Payment Amount</label>
                                <input placeholder="Payment Amount" class="form-control" type="number" name="paymentAmount" value=0>
                            </div>
                        </div>

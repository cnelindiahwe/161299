...
class Zt2016_expensesdata extends MY_Controller {
	...
	{
        $this->load->model('zt2016_expenses_model');
        ...
        if(isset($expenses['submit'])){
            ...
            $expensesDBinfo=$this->zt2016_expenses_model->addexpenses($expenses);
        ...
        if(isset($expenses['update'])){
            ...
            $expensesDBinfo=$this->zt2016_expenses_model->UpdateExpensesEntrie($expenses);
        ...
        if(isset($expenses['delete'])){
            ...
            $expensesDBinfo=$this->zt2016_expenses_model->DeleteExpensesEntrie($expenses);
        ...
        if(isset($expenses['filter'])){
            ...
            if($expenses['paidBy']== 'Paid By (All)'){
                $expenses['paidBy'] = '';
            }
           
            if($expenses['Category']== 'Category (All)'){
                $expenses['Category'] = '';
            }
            $expensesDBinfo=$this->zt2016_expenses_model->GetExpensesEntrie($expenses);

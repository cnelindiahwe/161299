...
//  print_r($OngoingEntries);
		...
		######### panel header
		$page_content.='<div class="panel panel-info" id="top-panel" style="background: rgb(204, 231, 244);"><div class="panel-heading p-2">'."\n"; 
			
			$page_content.=	"<h4>";
		    
			#### Entries summary
			$page_content.=	"<div class=\"row\"><div class=\"col-sm-5\">";

			$page_content.=_displayOngoingJobsSummary($OngoingEntries,$ZOWuser);
			$page_content.="</div><div class=\"col-sm-7 add_new_b\">";
			#### Trash button
			$page_content.= '<a href="'.site_url().'zt2016_new_job" class="col-sm-3  btn  me-1 mt2 text-light" style="border-radius: 20px;background-image: linear-gradient(to bottom,rgb(66, 139, 202) 0,rgb(45, 108, 162) 100%);border-color: rgb(43, 102, 154);"><i class="fa fa-plus"></i> New Job </a>'."\n";

			$page_content.= '<a href="'.site_url().'trash/zt2016_trash" class="col-sm-3  btn btn-info me-1 mt2 " style="border-radius: 20px;">View Trash</a>'."\n";
		
			#### Past jobs button
			$page_content.= '<a href="'.site_url().'tracking/zt2016_past_jobs" class="col-sm-3  btn  me-1 mt2  " style="border-radius: 20px;background-image: linear-gradient(to bottom,rgb(255, 255, 255) 0,rgb(224, 224, 224) 100%);border-color: rgb(204, 204, 204);color: #000;">Past Jobs</a>'."\n";
		...
		######### panel body
		$page_content.='<div class="panel-body "><div class="table-responsive">'."\n";

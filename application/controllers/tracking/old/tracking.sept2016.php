...
class Tracking extends MY_Controller {
	...
	public function index()
	{
		...
		$this->load->helper(array('zowtrakui','tracking','general','url','form','userpermissions'));	
	...
	function  _listPastJobs()
	{
		...
		$getentries = $this->trakentries->GetCompletedEntries($options = array('Trash' => '0', 'sortByNew'=> '1', 'limit'=> '20'));
		if($getentries)
		{

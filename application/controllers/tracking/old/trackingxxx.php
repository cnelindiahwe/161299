...
class Trackingnew extends MY_Controller {
	...
	public function index()
	{
		...
		$this->load->helper(array('trackingnew','general','url','form','userpermissions'));	
	 ...
	 $templateVars['ZOWuser']=_getCurrentUser();
		...
		//$templateVars['pageInput'] = $this->_getEntries($CalendarMonth,$CalendarYear);
		$templateVars['pageInput'] = $this-> _pastjobscontrol();
		$templateVars['pageInput'] = $this-> _listPastJobs();
		//$templateVars['pageSidebar'] = _getEntryForm($getclients);

	...
	function _display_edit_entry_page( $FormEntryData)
	{
		...
		##########################################		
			...
			if ($OriginalDBEntry->Status=="COMPLETED" || $OriginalDBEntry->Status=="BILLED" || $OriginalDBEntry->Status=="PAID" || $OriginalDBEntry->Status=="MARKETING" || $OriginalDBEntry->Status=="WAIVED") {
				...
				$ZOWStaffList = array ("", "Arpita", "Agnel", "Ashish", "Dinesh", "Divya", "Ganesh", "Hussain", "Hiren", "Jemema", "Jirka", "Joseph", "Kanchan", "Manali", "Miguel", "Nainesh", "Nandhinipriya", "Nazima","Poojari", "Prakash", "Pranjali", "Saakshi", "Seemakaur", "Sharique", "Shital", "Shreyas", "Sijo","Seema", "Sneha","Sowmya", "Subathra", "Sunil", "Suyog" ,"Tarun", "Vaishali");
				
			} else{
				$ZOWStaffList = array ("","Arpita","Ashish", "Ganesh", "Hiren", "Jemema", "Jirka", "Miguel", "Nainesh", "Nandhinipriya","Nazima","Pranjali", "Seemakaur", "Sijo","Sowmya", "Subathra", "Sunil");
			}
		...
		$page_content.='<div class="panel-heading">'."\n"; 
			...
			$page_content .="</fieldset>\n";
			$ndata = array('class' => 'submitButton btn btn-primary btn-xs form-control duplicate-button','value' => 'Duplicate Job','name' => 'JobDuplicateSubmit','id' => 'JobDuplicateSubmit','style'=>" height:30px;" );

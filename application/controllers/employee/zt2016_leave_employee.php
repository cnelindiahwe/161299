...
class zt2016_leave_employee extends MY_Controller {
    ...
    function _display_page ($ZOWuser)
	{
		...
		<div class="panel panel-info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile" class="avatar avatar-xs"><img src="<?php echo base_url();?>/assets/img/profiles/avatar-09.jpg" alt=""></a>
                ...
                <div id="add_leave" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document" style="vertical-align: unset;"> 

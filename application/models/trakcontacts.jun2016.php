<?php class Trakcontacts extends CI_Model {
	...
	function AddEntry($options =  array())
	{
		...
		$qualificationArray = array('LastName','FirstName','CompanyName','FirstContactIteration','Title','TimeZone','Email1', 'Email2', 'Cellphone1','Cellphone2','Officephone1','Officephone2','Homephone1','Homephone2','OfficeAddress','OfficeZipcode','OfficeCity','OfficeCountry','HomeAddress','HomeZipcode','HomeCity','HomeCountry','Notes','Trash');
    ...
    // required values
		...
		// qualification (make sure that we're not allowing the site to insert data that it shouldn't)
		$qualificationArray = array('ID','LastName','FirstName','CompanyName','FirstContactIteration','Title','TimeZone','Email1', 'Email2', 'Cellphone1','Cellphone2','Officephone1','Officephone2','Homephone1','Homephone2','OfficeAddress','OfficeZipcode','OfficeCity','OfficeCountry','HomeAddress','HomeZipcode','HomeCity','HomeCountry','Notes','Trash');

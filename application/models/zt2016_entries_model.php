<?php class zt2016_entries_model extends CI_Model {
	...
	function AddEntry($options =  array())
	{
		...
		$qualificationArray = array('Client','Code', 'DateIn','TimeIn','TimeZoneIn','DateOut','TimeOut','ScheduledDateOut','ScheduledTimeOut','TimeZoneOut', 'Originator', 'NewSlides', 'EditedSlides','Hours','RealTime','WorkType','FileName','ProjectName','Status','MonthPrice','Currency','JobPrice','HoursBilled','Invoice','Trash','TentativeBy','ScheduledBy','WorkedBy','ProofedBy','CompletedBy','BilledBy','PaidBy','EntryNotes','NewSlides_2','NewSlides_3','EditedSlides_2','EditedSlides_3','Hours_2','Hours_3','has_multi_worked','WorkedBy_2','WorkedBy_3');
    ...
    // required values
		...
		// qualification (make sure that we're not allowing the site to insert data that it shouldn't)
		$qualificationArray = array('id','Client','Code',  'DateIn','TimeIn','TimeZoneIn','DateOut','TimeOut','ScheduledDateOut','ScheduledTimeOut','TimeZoneOut',  'Originator', 'NewSlides', 'EditedSlides','Hours','RealTime','WorkType','FileName','ProjectName', 'NewDate','Status','MonthPrice','Currency','JobPrice','HoursBilled','Invoice','Trash','TentativeBy','ScheduledBy','WorkedBy','ProofedBy','CompletedBy','BilledBy','PaidBy','EntryNotes','NewSlides_2','NewSlides_3','EditedSlides_2','EditedSlides_3','Hours_2','Hours_3','has_multi_worked','WorkedBy_2','WorkedBy_3');
	...
	*/
		function GetCompletedEntries($options = array())
	{
		...
		$status= array('COMPLETED', 'BILLED', 'PAID','DISPUTED','MARKETING','WAIVED');

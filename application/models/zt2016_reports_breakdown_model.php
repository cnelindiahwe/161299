<?php class Zt2016_reports_breakdown_model extends CI_Model {
	...
	*/
	...
	/**
	* OriginatorsByDate gives number of originators between dates
	*
	* @param array $required
	* @param array $data
	* @return bool
	*/
	function _OriginatorsByDate($options =  array())
	{
	...
	* @return bool
	*/
	function _BookedOriginatorsByDate($options =  array())
	{
	...
	/**
	* _getAllOriginatorsBilledTotalsByDate gives billed totals for all originator between dates
	*
	* @param array $required
	* @param array $data
	* @return bool
	*/
	...
	/**
	* _getAllOriginatorsCompletedTotalsByDate gives Completed totals for all originators between datess
	*
	* @param array $required
	* @param array $data
	* @return bool
	*/
	...
	function  _getAllOriginatorsCompletedTotalsByDate($options = array())
	{
		...
		/**
	/**
	* _getAllOriginatorsEllapsedTotalsByDate gives booked totals for all clients between datess
	*
	* @param array $required
	* @param array $data
	* @return bool
	*/
	...
	function  _getAllOriginatorsOngoingTotalsByDate($options = array())
	{
	...
	*/
	...
	function  _getAllClientsBilledTotalsByDate($options = array())
	{
	...
	* @return bool
	*/	
	function  _getClientsTotalsByDate($StartDate,$EndMonth,$clientb,$Status,$Booked)
	{
		  //Get BOOKED totals from db
	...
	* @return bool
	*/	
	function  _getClientsBilledTotalsByDate($StartDate,$EndMonth,$clientb,$Status)
	{
		  //Get BOOKED totals from db
		  $this->db->select($Status);
		  $this->db->select_sum('Hours','Hours');
	...
	*/
	...
	function  _getAllClientsCompletedTotalsByDate($options = array())
	{
	...
	*/
	...
	function  _getAllClientsOngoingTotalsByDate($options = array())
	{
